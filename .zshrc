...
[ ! -f "$HOME/.local/share/bin/logo-ls" ] && cd /tmp/ && wget "https://github.com/Yash-Handa/logo-ls/releases/download/v1.3.7/logo-ls_Linux_x86_64.tar.gz"  && tar xf logo-ls_Linux_x86_64.tar.gz && cp logo-ls_Linux_x86_64/logo-ls ~/.local/share/bin/ && cd ~
[ ! -f "$HOME/.local/share/bin/bat" ] && cd /tmp/ && wget "https://github.com/sharkdp/bat/releases/download/v0.23.0/bat-v0.23.0-x86_64-unknown-linux-gnu.tar.gz"  && tar xf bat-v0.23.0-x86_64-unknown-linux-gnu.tar.gz && cp bat-v0.23.0-x86_64-unknown-linux-gnu/bat ~/.local/share/bin/ && cd ~
